...
const typographyVariants = cva("selection:bg-red-500/70 selection:text-light", {
  variants: {
    type: {
      ...
      h3: "pt-20 pb-8 lg:pt-18 text-center text-4xl font-semibold bg-linear-to-r from-pink-500 to-amber-500 bg-clip-text text-transparent",
      h4: "bg-foreground2 py-0.5 px-6 lg:px-10 rounded-lg text-background text-lg lg:text-2xl font-semibold",
      p: "text-lg leading-7 [&:not(:first-of-type)]:mt-6",
      default: "",
